...
# Erstellen der value_counts, hier für die Spalte V3_VMheute --> Verkehrsmittel Heute 2024
...
mylabels = ["Bus und Bahn", "Pkw", "Fahrrad", "Zu Fuß", "Mot. Zweirad"]
explode = [0.1, 0, 0, 0, 0]
